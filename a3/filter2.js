function combine_and_filter1(trump_tweets, obama_tweets, tsne_data_trump, tsne_data_obama) {
  ...
  function make_plot1(tweets){
    ...
    Plotly.newPlot('posFilt', data, layout);
  }
    ...
    Plotly.d3.csv("data/obama_presidential_tweets.csv", (obama_tweets) => {
      Plotly.d3.csv("data/tsne_and_cluster/tsne_data_trump.csv", (tsne_data_trump) => {
        Plotly.d3.csv("data/tsne_and_cluster/tsne_data_obama.csv", (tsne_data_obama) => {
          let tweets = combine_and_filter1(trump_tweets, obama_tweets, tsne_data_trump, tsne_data_obama)
          make_plot1(tweets);
        });
      });
    });
